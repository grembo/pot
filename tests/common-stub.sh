...
common_setUp()
{
	...
	_POT_VERBOSITY=1
	POT_DNS_NAME=dns
	__mon_put ERROR_CALLS 0
	__mon_put INFO_CALLS 0
	__mon_put DEBUG_CALLS 0
	__mon_put ISUID0_CALLS 0
	__mon_put ISPOT_CALLS 0
	__mon_put ISPOTRUN_CALLS 0
	__mon_put ISBASE_CALLS 0
	__mon_put ISFSCOMP_CALLS 0
	__mon_put GETCONFVAR_CALLS 0
	__mon_put GETPOTBASE_CALLS 0
	__mon_put ZFSEXIST_CALLS 0
	__mon_put POTZFSSNAP_CALLS 0
	__mon_put RMVPOTSNAP_CALLS 0
	__mon_put POTZFSSNAPFULL_CALLS 0
	__mon_put FSCOMPZFSSNAP_CALLS 0
	__mon_put RMVFSCOMPSNAP_CALLS 0
	__mon_put GETBRIDGEVAR_CALLS 0
}
